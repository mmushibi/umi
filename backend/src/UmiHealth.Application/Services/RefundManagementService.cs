...
namespace UmiHealth.Application.Services
{
    public interface IRefundManagementService
    {
        ...
        Task<List<RefundRequestEntity>> GetPendingRefundsAsync(Guid tenantId);
        ...
        Task<List<RefundRequestEntity>> GetRefundHistoryAsync(Guid tenantId, Guid? customerId = null, DateTime? startDate = null, DateTime? endDate = null);
    ...
    public class RefundManagementService : IRefundManagementService
    {
        ...
        public async Task<List<RefundRequestEntity>> GetPendingRefundsAsync(Guid tenantId)
        {
        ...
        public async Task<List<RefundRequestEntity>> GetRefundHistoryAsync(Guid tenantId, Guid? customerId = null, DateTime? startDate = null, DateTime? endDate = null)
        {
        ...
        private byte[] GeneratePdfReport(RefundAnalytics analytics, List<RefundRequestEntity> requests)
        {
        ...
        private byte[] GenerateExcelReport(RefundAnalytics analytics, List<RefundRequestEntity> requests)
        {
        ...
        private byte[] GenerateCsvReport(List<RefundRequestEntity> requests)
        {
